package android.italo.modularpam1italocalculo;
...
public class MainActivity extends AppCompatActivity {
    EditText nota1, nota2, nota3, nota4, falta;
    Button btnCalcular;
    ...
    private void calcular() {
        ...
        double f = Double.parseDouble(falta.getText().toString());
    ...
    private void validaCampos() {
        ...
        }else if (TextUtils.isEmpty(falta.getText())) {
            falta.setError("Esse campo nao pode estar vazio!!");
        }
    }
    ...
    private void initComponents() {
        ...
        falta = findViewById(R.id.edt_falta);
        btnCalcular = findViewById(R.id.btn_calculo);
    }
